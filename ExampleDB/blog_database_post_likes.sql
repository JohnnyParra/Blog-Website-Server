...
CREATE TABLE `post_likes` (
  ...
  KEY `fkpost_likes_user_id_idx` (`user_id`),
  KEY `fkpost_likes_post_id_idx` (`post_id`),
...
INSERT INTO `post_likes` VALUES ('4lnhTH_XIPWPcgUsTpvDR',1),('Ac_a5QW2gsGRdlYqnHzCP',1),('ZLWfS1uZRqdoCa_Aytg0H',1),('Ac_a5QW2gsGRdlYqnHzCP',2);
